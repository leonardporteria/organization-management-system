...
values
('120316006-E1', 'Elementary', 'Payatas Elementary School', '1992-04-24', 'N/A'),
('120316006-E2', 'High School', 'Payatas National High School', '1996-04-19', 'N/A'),
('120316006-E3', 'College', 'Philippine Normal University', '2000-08-03', 'Accountancy'),

('140108002-E1', 'Elementary', 'Malabon Elementary School', '1993-04-30', 'N/A'),
('140108002-E2', 'High School', 'Malabon National High School', '1997-05-04', 'N/A'),
('140108002-E3', 'College', 'University of the East', '2004-09-30', 'Human Resource Management'),

('171220003-E1', 'Elementary', 'Camalig Elementary School', '2001-04-17', 'N/A'),
('171220003-E2', 'High School', 'Camarin Barangay High School', '2007-04-23', 'N/A'),
('171220003-E3', 'College', 'Our Lady of Fatima University', '2011-05-14', 'Nursing'),

('190600004-E1', 'Elementary', 'Camalig Elementary School', '2004-04-06', 'N/A'),
('190600004-E2', 'High School', 'Camalig National High School', '2008-04-22', 'N/A'),
('190600004-E3', 'College', 'Centro Escolar University', '2013-06-28', 'Secondary Education Major in English'),

('182210001-E1', 'Elementary', 'UP - Integrated School', '2002-06-14', 'N/A'),
('182210001-E2', 'College', 'University of the Philippines - Diliman', '2007-05-01', 'N/A'),
('182210001-E3', 'College', 'University of the Philippines - Diliman', '2013-07-26', 'Information Technology'),

('160980334-E1', 'Elementary', 'Catmon Elementary School', '1994-04-14', 'N/A'),
('160980334-E2', 'High School', 'Lolomboy National High School', '1998-04-04', 'N/A'),
('160980334-E3', 'College', 'UP - Integrated School', '2002-06-14', 'N/A'),

('190080116-E0', 'Primary School', 'Tagapo Elemantary School', '2001-04-24', 'N/A'),
...
('220310045-E0', 'Primary School', 'San Pablo Elementary School', '2012-03-11', 'N/A'),
...
('171190031-E0', 'Primary School', 'Balabag Elementary School', '2011-05-11', 'N/A'),
('171190031-E1', 'Junior High School', 'Boracay National High School', '2015-05-11', 'N/A'),

('192030058-E0', 'Primary School', 'Juan Sumulong Elementary School', '2009-04-04', 'N/A'),
...
('162310092-E0', 'Primary School', 'Iloilo Central Elementary School', '1999-04-13', 'N/A'),
...
('162310092-E3', 'College', 'Hua Siong College of Iloilo, Ledesco Campus', '2007-04-13', 'N/A');
  ...
  await pool.query(`
    insert into member_information(member_id, member_name, place_of_birth, date_of_birth, address, age, sex, heigh_in_cm, weight_in_kg, bmi, civil_status, nationality, religion, blood_type, telephone_number, cellphone_number, email, sponsor_name, sponsor_membership_id, work_title_or_position, company_code)
    values ('182210001', 'Liam Jose', 'Manila, Metro Manila, Philippines', '1995-08-12', '456 P. Burgos Street, Barangay Poblacion, Makati City, Metro Manila, Philippines', age, 'M', 165, 60, bmi, 'Single', 'Filipino', 'Catholic', 'AB', '5821234567', '09171234567', 'liamjose@gmail.com', null, null, 'Software Developer', '183020-W1'),
	('140108002', 'Emma Tomas', 'Cebu City, Cebu, Philippines', '1987-04-23', '789 Mabini Avenue, Barangay Malate, Metro Manila', age, 'F', 172, 68, bmi, 'Married', 'Filipino', 'Christian', 'B', '6512345678', '9262345678', 'emmatomas@gmail.com', 'Liam Jose', '182210001', 'Marketing Manager', '171640-W2'),
    ('171220003', 'Noah David', 'Davao City, Davao del Sur, Philippines', '1990-11-05', '123 Rizal Street, Barangay Santa Cruz, Quezon City, Metro Manila, Philippines', age, 'M', 158, 55, bmi, 'Single', 'Filipino', 'Adventist', 'A-', '2523456789', '09323252858', 'noahdavid@gmail.com', null, null, 'Nurse', '201950-W3'),
	('190600004', 'Olivia Mercedes', 'Quezon City, Metro Manila, Philippines', '1992-03-17', '456 J.P. Laurel Street, Barangay San Antonio, Pasig City, Metro Manila, Philippines', age, 'F', 180, 75, bmi, 'Single', 'Filipino', 'Catholic', 'A', '8786438654', '09875386729', 'olivia_m@gmail.com', 'Liam Jose', '182210001', 'Customer Service Representative', '220440-W4'),
	('120316006', 'William Garcia', 'Bacolod City, Negros Occidental, Philippines', '1984-09-29', '789 Taft Avenue, Barangay Malibay, Pasay City, Metro Manila, Philippines', age, 'M', 155, 50, bmi, 'Married', 'Filipino', 'Catholic', 'O', '8923745274', '09647284728', 'will_grc@gmail.com', 'Liam Jose', '182210001', 'Accountant', '152200-W5'),
	('160980334', 'Krisha Martinez', 'Quezon City, Metro Manila, Philippines', '1982-12-10', '123 Orchid Street, Pasig City', age, 'F', 152, 55, bmi, 'Single', 'Filipino', 'Catholic', 'O', '4352276849', '09876834768', 'krish_mar@gmail.com', 'Olivia Mercedes', '190600004', 'Human Resource Manager', '220440-W4'),
	('190080116', 'Samantha Cruz', 'Santa Rosa City, Laguna', '1989-12-02', '123 Purok 6, Barangay Tagapo, City of Sta. Rosa, Laguna', age, 'F', 160, 70, bmi, 'Married', 'Filipino', 'Dating Daan', 'O', '9817402964', '09187284193', 'samanthacruz@gmail.com', null, null, 'Human Resource Manager', '190080-W1'),
    ('220310045', 'Oliver Ramil', 'Baguio City, Benguet', '2000-03-25', 'Kilometer 80, Maharlika Highway, Barangay San Rafael, San Pablo City, Laguna', age, 'M', 171, 68, bmi, 'Single', 'Filipino', 'Adventist', 'A', '8719209148', '09718274192', 'oliver.ramil@gmail.com', null, null, 'Quality Assurance Analyst', '220310-W1'),
    ('171190031', 'Angelica Ramos', 'Manila City, Metro Manila', '1999-10-28', 'Plazotela, Station II, Boracay Island, Malay, Aklan', age, 'F', 177, 72, bmi, 'Single', 'Filipino', 'Christian', 'AB', '9817492752', '09179276467', 'angelica_ramos28@gmail.com', 'Oliver Ramil', '220310045', null, null),
    ('192030058', 'Anthony Topez', 'Tagaytay City, Cavite', '1997-05-14', '7 Blk 1a-4 Road 18 Phase 5 Cogeo Village,1870, Antipolo City, Rizal', age, 'M', 165, 62, bmi, 'Single', 'Filipino', 'Catholic', 'A-', '9182701837', '09068182942', 'a.topez@gmail.com', 'Emma Tomas', '140108002', 'Senior Accounting Analyst', '192030-W1'),
    ('162310092', 'George Delos Reyes', 'Batangas City, Batangas', '1987-11-12', 'Q. Abeto Street, Barangay Abeto Rizal, Iloilo City', age, 'M', 162, 67, bmi, 'Married', 'Filipino', 'Catholic', 'B', '9183747491', '09168276391', 'george.dr@gmail.com', null, null, 'Financial Analyst', '162310-W1');
  `);
  ...
  await pool.query(`
    ...
    values ('182210001', 'CLUB16208008', '182210001-E1', '182210001-D1', '182210001-C1', 'Active', '2018-08-19'),
       ('182210001', 'CLUB16208008', '182210001-E2', '182210001-D1', '182210001-C1', 'Active', '2018-08-19'),
       ('182210001', 'CLUB16208008', '182210001-E3', '182210001-D1', '182210001-C1', 'Active', '2018-08-19'),

       ('171220003', 'CLUB15204007', '171220003-E1', '171220003-D1', '171220003-C1', 'Active', '2017-03-15'),
       ('171220003', 'CLUB15204007', '171220003-E2', '171220003-D1', '171220003-C1', 'Active', '2017-03-15'),
       ('171220003', 'CLUB15204007', '171220003-E3', '171220003-D1', '171220003-C1', 'Active', '2017-03-15'),

       ('190600004', 'CLUB23004001', '190600004-E1', NULL, '190600004-C1', 'Active', '2019-03-27'),
       ('190600004', 'CLUB23004001', '190600004-E2', NULL, '190600004-C1', 'Active', '2019-03-27'),
       ('190600004', 'CLUB23004001', '190600004-E3', NULL, '190600004-C1', 'Active', '2019-03-27'),

       ('140108002', 'CLUB19312003', '140108002-E1', '140108002-D1', '140108002-C1', 'Active', '2014-07-16'),
       ('140108002', 'CLUB19312003', '140108002-E2', '140108002-D1', '140108002-C1', 'Active', '2014-07-16'),
       ('140108002', 'CLUB19312003', '140108002-E3', '140108002-D1', '140108002-C1', 'Active', '2014-07-16'),

       ('120316006', 'CLUB19190006', '120316006-E1', '120316006-D1', '120316006-C1', 'Active', '2012-11-06'),
       ('120316006', 'CLUB19190006', '120316006-E2', '120316006-D1', '120316006-C1', 'Active', '2012-11-06'),
       ('120316006', 'CLUB19190006', '120316006-E3', '120316006-D1', '120316006-C1', 'Active', '2012-11-06'),

       ('120316006', 'CLUB19190006', '120316006-E1', '120316006-D2', '120316006-C1', 'Active', '2012-11-06'),
       ('120316006', 'CLUB19190006', '120316006-E2', '120316006-D2', '120316006-C1', 'Active', '2012-11-06'),
       ('120316006', 'CLUB19190006', '120316006-E3', '120316006-D2', '120316006-C1', 'Active', '2012-11-06'),
	   ...
	   ('220310045', 'CLUB15204007', '220310045-E0', '220310045-D1', '220310045-C1', 'Active', '2020-07-06'),
	   ('220310045', 'CLUB15204007', '220310045-E1', '220310045-D2', '220310045-C1', 'Active', '2020-07-06'),
	   ('220310045', 'CLUB15204007', '220310045-E3', '220310045-D1', '220310045-C1', 'Active', '2020-07-06'),
